    ...
    return (
        <div className='shadow-lg'>
            <div className=' px-3 mb-5'>
                <div className="list-group-item text-light rounded-1  p-1 px-2" aria-current="true" style={{ background: '#4267b2' }}>
                                ...
                                <div className="row border-bottom pb-3  mx-4">
                                    <div className="col-md-4">
                                        <div className="form-group row">
                                            ...
                                            <div className="col-md-6">
                                                <input type="number" step="1" name="parent_id" className="form-control form-control-sm " id="parent_id" placeholder="Enter Parent Id" defaultValue={data.id} />
                                            </div>
                                                ...
                                                <div className="input-group d-flex">
                                                    <div className="input-group-append">
                                                        <IconModal
                                                            ...
                                                            index={index}
                                                            pageGroupIcon={data.page_group_icon}
                                                        ></IconModal>
