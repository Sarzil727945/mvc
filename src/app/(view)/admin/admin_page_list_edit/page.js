...
const AdminPageEditAll = ({ Id, controllerName, pageGroup, controllerSort, pageGroupSort, controllerBg, controllerColor }) => {
                        ...
                        <div key={data.id}>
                            <div >
                                <div className="w-100 px-4 pb-2 pt-3">
                                    ...
                                    <a
                                        data-admin_page_list="admin_page_list"
                                        data-id_admin_page_list="794"
