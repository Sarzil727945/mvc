...
const IconModal = ({ index, names, handleInputChange, inputValue, Icon, pageGroupIcon }) => {
        ...
        <div >
            <div className=' d-flex'>
                <button className="btn btn-sm btn-success icon794_view" id="icon794_view" type="button">
                    <span
                        dangerouslySetInnerHTML={{ __html: Icon || pageGroupIcon || iconValue[iconValue.length - 1] }}
                    ></span>
                </button>
                <div className="input-group d-flex">
                    <input
                        ...
                        defaultValue={Icon || pageGroupIcon || iconValue[iconValue.length - 1]}
